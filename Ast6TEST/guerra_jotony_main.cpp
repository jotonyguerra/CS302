...
int main(){
    ...
    //loop for error on opening file
    ...
    //loop to use header functions to initialize hash and search for solution using bruteForce functio from geeksForgeeks
    while(size != 0){
